...
Flags:
  -d, --dir string      directory with kubeconfigs (default "/home/user/.kube/configs")
  ...
  -c, --clip            when --no-shell is provided, copy 'export KUBECONFIG=PATH' to clipboard instead of printing to stdout
